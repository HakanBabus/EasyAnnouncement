...
class AnnouncementCommand extends Command implements PluginOwned
{
    public function __construct(
        public EasyAnnouncement $main, 
        public $cmdarray, string $name, 
    ...
    public function getOwningPlugin(): EasyAnnouncement
    {
        return $this->main;
    }
}